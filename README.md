This is a reproduction on the paper "(Re-)Imag(in)ing Price Trends", where the time series data is transformed into 2-dimensional pictures and then analyzed by the CNN neural network.
